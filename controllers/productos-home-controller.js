...
const nuevoProducto = (name,price,imageurl,id) =>{
    ...
    const contenido = ` 
        <ul class="producto__ul">
            ...
            <li class="producto__button"><button  class="producto__button-verprod"> <a href="/screens/describirProducto.html?id=${id}">Ver Producto</a></button></li>
        </ul>
    `;
    card.innerHTML = contenido;
    card.classList.add("producto__box");
    if(window.location.pathname == "/screens/index.html"){
